...
/**
 * <code>FoodBanana</code> class controls rendering of the
 * banana food.
 */
public class FoodBanana extends Food {

    /**
     * Constructor of <code>FoodBanana</code> class only calls
     ...
     */
    public FoodBanana(Handler handler, float x, float y) {
    ...
    public void render(Graphics g) {
        g.drawImage(Assets.foodBanana, (int) x, (int) y, width, height, null);
    }
}
